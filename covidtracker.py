...
twitterimg_path = PhotoImage(file="images/twittericon.png")
youtubeimg_path = PhotoImage(file="images/youtubeicon.png")
searchimg_path = PhotoImage(file="images/searchimg.png")
...
twitterButton = Button(GUIWorkspace, font = font_button_tuple, image=twitterimg_path,cursor='hand2',border='0',command=openTwitter)
twitterButton.place(x=1280,y=630)
ytButton = Button(GUIWorkspace, font = font_button_tuple, image=youtubeimg_path,cursor='hand2',border='0',command=openYouTube)
ytButton.place(x=1200,y=630)
...
search_button = Button(GUIWorkspace, font = font_tuple, image= searchimg_path,cursor="hand2",border='0',command = search_by_country)
search_button.pack()
